...
import it.uniroma3.dia.giw.repositories.InMemoryInputRepository;
...
@Test
public class InMemoryInputOutputRepositoryPerformanceTest extends
        BaseStoreQueryRepositoryPerformanceTest {
    
    private static final Logger LOGGER = LoggerFactory
            .getLogger(InMemoryInputOutputRepositoryPerformanceTest.class);
    ...
    protected void initRepositories() throws Exception {
        ...
        super.writeRepository = new InMemoryInputRepository(streams, timelinePages, followerPages,
                followingPages);
