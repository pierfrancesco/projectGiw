...
import it.uniroma3.dia.giw.repositories.ElasticSearchInputRepositoryNew;
...
@Test
public class ElasticSearchStoreQueryRepositoryPerformanceTestNew extends
    ...
    protected void initRepositories() throws Exception {
        ...
        if (this.localNode == null) {
            ...
            final CreateIndexRequest tweetsIndex = Requests
                    .createIndexRequest(ElasticSearchInputRepositoryNew.DATABASE_NAME);
            ...
            this.localNode.client().admin().indices()
                    .preparePutMapping(ElasticSearchInputRepositoryNew.DATABASE_NAME)
                    .setType(ElasticSearchInputRepositoryNew.CONTEXT_TWEET_TYPE)
                    .setSource(tweetMapping()).execute().actionGet();
        }
        
        final ObjectMapper objectMapper = new ObjectMapper();
        super.writeRepository = new ElasticSearchInputRepositoryNew(localClientNode, objectMapper);
    ...
    public XContentBuilder tweetMapping() throws Exception {
        ...
        XContentBuilder tweetMapping = jsonBuilder()
                .startObject()
                .startObject(ElasticSearchInputRepositoryNew.CONTEXT_TWEET_TYPE)
                .startObject("properties")
                .startObject(ElasticSearchInputRepositoryNew.TWEET_FIELD)
                .startObject("properties")
                .startObject(ElasticSearchInputRepositoryNew.USER_FIELD)
                .startObject("properties")
                ...
                .endObject()
                // properties
                .startObject(ElasticSearchInputRepositoryNew.CONTEXT_TWEET_ID)
                ...
                .startObject(ElasticSearchInputRepositoryNew.MONITORING_ACTIVITY_ID)
