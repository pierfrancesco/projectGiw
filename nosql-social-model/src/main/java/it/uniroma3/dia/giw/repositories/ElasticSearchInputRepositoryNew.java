...
public class ElasticSearchInputRepositoryNew implements InputRepository {
    ...
    @Inject
    public ElasticSearchInputRepositoryNew(final Node node, final ObjectMapper objectMapper) {
